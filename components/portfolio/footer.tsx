      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-[#71717A] font-mono">
            You are the <span className="text-white">24,592</span>
            <sup>nd</sup> visitor
          </p>
          ...
          <div className="flex items-center gap-3">
            {socials.map((social) => (
              <a
                ...
                className="w-8 h-8 rounded-lg bg-[#111118] border border-[#1F1F2A] flex items-center justify-center text-[#71717A] hover:text-white hover:border-[#7C3AED]/30 transition-all"
              >
        ...
        <div className="mt-6 text-center">
          <p className="flex items-center justify-center gap-1 text-xs text-[#52525B]">
            Built with <Heart className="h-3 w-3 text-[#7C3AED]" /> using
            Next.js
          </p>
