      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="space-y-8">
          {experiences.map((exp, i) => (
            <div
              key={i}
              className="group relative rounded-2xl bg-[#111118] border border-[#1F1F2A] p-6 md:p-8 card-glow"
            >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {exp.current && (
                        <span className="px-2 py-0.5 rounded-full bg-[#7C3AED]/10 border border-[#7C3AED]/20 text-[#7C3AED] text-xs font-mono">
                          Current
                        </span>
                      )}
                    </div>
              ...
              <ul className="space-y-2 mb-6">
                {exp.description.map((desc, j) => (
                  ...
                  >
                    <ChevronRight className="h-4 w-4 text-[#7C3AED] flex-shrink-0 mt-0.5" />
                    {desc}
                  </li>
                ))}
              </ul>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap gap-2">
            {techBadges.map((tech) => (
              <span
                key={tech}
                className="px-3 py-1.5 rounded-lg bg-[#111118] border border-[#1F1F2A] text-sm text-[#A1A1AA] font-mono hover:border-[#7C3AED]/30 hover:text-white transition-all cursor-default"
              >
                {tech}
              </span>
            ))}
