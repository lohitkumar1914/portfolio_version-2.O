    ...
    <section id="contact" className="py-24 relative">
      <div className="mx-auto max-w-5xl px-6">
        <div className="relative rounded-2xl bg-[#111118] border border-[#1F1F2A] p-10 md:p-16 text-center overflow-hidden">
          {/* Glow effects */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-[#7C3AED]/10 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="relative">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#7C3AED] text-white text-sm font-medium hover:bg-[#6D28D9] transition-colors glow-violet-strong"
            >
